...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://73x9ggncdc.execute-api.us-east-1.amazonaws.com/v1';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['labels', 'filename'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['labels', 'filename']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
